...
const VehicleDocConfig = () => {
  ...
  useEffect(() => {
    ...
    setStorage('vehicleDocumentTypes', documentTypes);
  }, [documentTypes]);
  ...
  return (
    <div className="p-6">
      <h2 className="text-xl font-bold mb-6 uppercase tracking-wide">Configurar Documentación Vehicular</h2>

      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        <h3 className="text-lg font-bold mb-4">Documentos Vehiculares Actuales</h3>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-lg font-bold mb-4">Agregar Nuevo Documento Vehicular</h3>
...
export default VehicleDocConfig;
